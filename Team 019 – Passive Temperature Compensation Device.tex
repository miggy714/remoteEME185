...
\section*{Improvements and Future Work}
    ...
    Following fabrication, physical validation will consist of two tests performed by the client: a dry test, in which the device is subjected to a controlled ambient temperature and the effective orifice diameter is optically measured; and a wet test, in which fluid flows at a specified inlet pressure and ambient temperature for 60 seconds while pressure drop is recorded. 
