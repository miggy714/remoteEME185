...
The transfer function produced the system output results shown in Figure \ref{TF}, verifying satisfaction of the required relationship despite these sources of error.
