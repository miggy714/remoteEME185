...
\section*{Problem Statement}
    ...
    where $A_1 = \Aone$ and $A_0 = \Azero$ \cite{ref_sandiaprompt}.
...
\end{figure}
    ...
    Aluminum's expansion rate $\alpha_{\text{Al}} \approx \specActuatorCTE$; it expands when heated. ALLVAR, a proprietary technology made by ALLVAR Alloys, shrinks when heated at a rate of $\alpha_{\text{ALLV}} \approx \specMountCTE$ \cite{ref_AllvarAlloys, ref_NASA_specs_Al}.
...
\section*{Evaluation and Verification}
    ...
    The resulting computation, represented graphically in Appendix~\ref{app:modeling}, analytically estimated the effect of heat transfer, machining errors, thermal expansion of every part, and spring reactions from the bellows.
...
% ------------------------------------------------------------
\section{A.1 \quad System Output of the \device}
% ------------------------------------------------------------
...
% ------------------------------------------------------------
\section{A.2 \quad Pressure Vessel Structural Verification}
% ------------------------------------------------------------
