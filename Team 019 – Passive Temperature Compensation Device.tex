...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, keepaspectratio]{Complete_Assembly_Render.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, keepaspectratio]{CompleteAssemblyExploded.png}
...
relationship between actuator displacement and flow restriction (Appendix~\ref{sec:flow}). The orifice is cut using wire EDM, allowing 
for a very small corner radius, which is critical for achieving the required precision in flow control. 
...
changes. The outer material, ALLVAR, shrinks when heated, while the inner material, Aluminum, expands. Thus, as the ambient temperature 
...
Sealing of the valve is achieved through a combination of welded joints and two Inconel 718 bellows. The bellows provide a hermetic seal while allowing for the 
...
of the design. Electron beam welding was selected for its ability to create strong, precise welds all of which will be verified through full radiographic inspection.
...
the specified requirements through the derived transfer function of the system:
