...
% ---------- Line Spacing ----------
\usepackage{setspace}
\onehalfspacing % 1.5 line spacing for easy reading
%-------- For Box diagrams
\usepackage{tikz}
...
\section*{Problem Statement}
	...
	Sandia commissioned the Noble Aggie Labs from UC Davis to design and prototype a Passive Temperature Compensation Device (PTCD)
    ...
    The PTCD must maintain this orifice, no larger than the tip of a ballpoint pen, to within a hair's breadth of its setpoint across a wide temperature range.
