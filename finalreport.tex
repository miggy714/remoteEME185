...
\label{chap:design}
	...
	\label{sec:design:overview}
		...
		The full assembly is pictured in Figures \ref{fig:reveal}, \ref{fig:mainExploded}, and \ref{fig:SubAssemblyID}.
	...
	\label{sec:design:just}
		...
		\label{subsec:design:just:mat}
			...
			\label{subsubsec:design:just:mat:Inc}
				...
				See Appendix~\ref{app:datasheets:mat} for relevant material data used throughout this report. Additional design justifications are provided in Appendix~\ref{subsec:design:just:gen_dim}.
...
\label{chap:DFMEA}
	...
	\label{sec:DFMEA:intro}
		...
		\begin{table}[h]
			...
			\begin{tabularx}{\textwidth}{>{\centering\arraybackslash}p{1.5cm} p{3cm} p{2.5cm} p{2.5cm} p{3cm} p{3cm}}
				\toprule
				\textbf{Part \#} & \textbf{Subsystem / Component Description} & \textbf{Component Function} & \textbf{Potential Failure Mode} & \textbf{Potential Effect of Failure} & \textbf{Potential Cause of Failure} \\
				\midrule
				2b & Housing Outlet Thin Wall & Supports valve orifice & Deformation & Loss of function, inaccurate test results & Pressure differential forces orifice into wall \\[6pt]
				2c & Housing Outlet Channel & Restricted diam channel from orifice & Deformation & Decreased function, small damage & Large pressure differential \\[6pt]
				2d & Housing Center Weld & Holds valve assembly & Stress failure & Damage to internals, loss of function & Stress concentrations \\[6pt]
				4  & Actuator Radial Weld & Fixes and seals actuator & Stress failure & Decreased function, inaccurate test, small damage & Thermal cycling, induced stress at weld toe \\[6pt]
...
\label{app:BOM}
	...
	A quote for the Wire Electrical-Discharge Machining (EDM) operation required to cut each square hole is also included from Milco Wire EDM, Inc; achievable tolerance values given in Section~\ref{sec:DFMEA:intro} were taken from this quote.
