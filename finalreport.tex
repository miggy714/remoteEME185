...
\subsection{Actuator-Housing Weldment}
    ...
    The weld joints are treated as full penetration fillet welds in this analysis, and the same assumptions made 
		...
		of the actuator mount to housing weld. The mount being made of ALLVAR has an anisotropic quality. It has a positive axial coefficient
  	...
  	temperature gradient using the maximum machined outer radius $R_0 = 9.0215 mm$
		$\Delta R = R_0 \left(\left(-\alpha_{\text{ALLV}}\right)\right) \Delta T_{\text{cold}}=0.0254mm$
		\todo{Note from Isaiah, yes it was absolutely wrong, my gosh what the heck was that}
		...
		The area of the weld and the area of the mount in contact with it are the same, and thus the
		 ...
		 295 MPA and 276 MPA respectively, assuming the weld metal has similar properties we find a sufficient safety factor:
		$$\text{FS} = \frac{S_{y,\text{weld}}}{\sigma_{\text{weld}}}=3.68$$
		Conservatively using the yield strength of Invar and assuming the weld metal has its properties we find the above.
  	...
  	reliable solution. Note that any sealing must only use materials resistant to hydrogen embrittlement and corrosion.
