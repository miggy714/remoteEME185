...
\label{chap:specs}
    ...
    \label{sec:specs:TF}
        ...
        Its value can be approximated as a first-order Taylor Expansion\cite{ref_Jensen}\cite{ref_Stewart} with very little error due to the linear behavior of thermal expansion. This yields
            ...
            \begin{itemize}
                \item $\ell_{M_0} = 38.541 \text{ mm} - 0.5 \text{ mm} = 38.041 \text{ mm}$\footnote{Top of the mount, for simplicity, is assumed to be the underside of the compressed belleville washer. Since this height is dependent on the use case, we will assume a 0.1 mm compression.}
        ...
        \label{subsec:spec:TF:pos}
            ...
            \begin{mdframed}
                \begin{align}
                    ...
                    K_H &= \frac{1}{2} + \frac{X_{ref}}{2\ell_{H_0}}
                \end{align}
            \end{mdframed}
