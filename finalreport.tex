...
\label{chap:design}
	...
	\label{sec:design:just}
		...
		\label{subsec:design:just:LBW}
			...
			The perimeter welds are certified to be free of defects such as porosity, lack of fusion, 
			...
			The axial stress on the weld is calculated as the force from the internal pressure distributed across the weld area.
			...
			\todo{Replace bending stress with Roark formulas}
