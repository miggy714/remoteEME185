...
\begin{enumerate}[label=\roman*.]
  ...
  \item \textbf{Calculations.}
  	...
  	temperature gradient with
		$\Delta R = R_0 \left(1 - \left(-\alpha_{\text{ALLV}}\right)\right) \Delta T_{\text{cold}}=0.0254mm$
		\todo{Isaiah, talk to Sam about this equation --- I think it's wrong}
		...
		\begin{equation}
			\sigma_{\text{ALLV}} = \frac{E_{\text{allvar}} \cdot \Delta R}{R_0} = \frac{55\times10^{9} \cdot 0.0254 \text{ mm}}{18 \text{ mm}} = 74.86 \text{ MPa}
		\end{equation}
  \item \textbf{Results.}
...
\begin{enumerate}[label=\roman*.]
	...
	\item \textbf{Assumptions, Principles, and Methods.}
	The assumptions for the Orifice Channel Opening are using the FEA results to find the maximum and average von Mises stress at the corner of the outlet opening.
	Reference the following chapter, Testing, for the complete principles and methods used for testing and FEA.
	\item \textbf{Calculations.}
	Using the data from the FEA testing, the factor of safety at the corner can be found. 

	See Figure~\ref{fig:FEAdisp2} for data from the FEA testing that will be used to calculate the FS at the corner of the outlet opening.
