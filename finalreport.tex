...
\label{chap:design}
	...
	\label{sec:design:just}
		...
		\begin{equation}
			...
			\end{aligned}
		\end{equation}
		\footnotetext{The bellows' two necks have different diameters; the smaller of those ("Neck 1" in the bellows catalog\cite{ref_miniflex_catalog}) connects to the Valve Orifice}
