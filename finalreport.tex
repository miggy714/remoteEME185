...
\label{chap:concl}
	...
	\label{sec:conc:fin_anal}
		...
		Mention that one of the fundamental objectives of this device (make sure this is included in section \ref{intro:motive}) is to be able to be adjusted later for its more specific use case.
