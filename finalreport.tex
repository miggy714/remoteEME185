...
\label{chap:Fintro}
	...
	\label{sec:intro:motive}
		...
		\label{subsec:intro:motive:background}
			...
			Their development of cutting-edge defense technology and pioneering scientific research protects American citizens and sojourners alike against myriad foreign and domestic threats.
			Resolving the nation's most challenging security issues, Sandia must employ every means necessary to maintain a competetive edge in the international theater.
			...
			Downstream conditions are sensitive to environmental temperature fluctuations and must be tightly controlled or extensively post-processed.
			...
			but switch on and off to compensate for the binary thermal extremes of space rather than operating continuously over their temperature range.
			...
			\label{subsec:intro:motive:objectives}
				...
				Thus it is that Sandia National Labs (SNL, aka the "sponsor" or the "client") employed the Noble Aggie Labs, a mechanical design team at the University of California in Davis and the authors of this paper,
		...
		\label{subsec:intro:motive:stakeholders}
			...
			\todo{Replace with schematic; mention fix-and-forget}

			The \device\ provides robust fix-and-forget control of experimental parameters.
			These experiments are run by the Gas Transfer Systems team to develop flow control components an assemblies,
...
\label{app:calcs}
	...
	\label{app:calcs:sup}
		...
		\label{app:calcs:sup:sec}
			...
			The \device\ plays a very niche role. It controls parameters for experiments used in the development of devices that aid in the development of Sandia's defense-technology projects.
			Figure \ref{fig:app_SNL} illustrates this division of responsibility and shows how the \device\ impacts its ultimate customer, United States National Security.

			\begin{figure}[H]
				\centering
				\includegraphics[height=4in]{SNL_role.png}
		...
		\label{app:calcs:sup:assem}
			...
			Figure \ref{fig:act_size} shows the actual size of the \device\ when printed $8 \nicefrac{1}{2}" \times 11"$ paper.
			...
			\begin{minipage}{6in}
				...
				\includegraphics[width=\textwidth]{reveal_qual.png}
				\caption{\device\ Full Assembly}
