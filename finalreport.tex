...
\begin{abstract}
	...
	Sandia commissioned the Noble Aggie Labs from the University of California, Davis to design and prototype a Passive Temperature Compensation Device (PTCD)
	...
	This Design Report illustrates the background, selected architecture, and expected performance of the PTCD and provides a full package required for further development,
	with the following objectives:

	\begin{itemize}
		\item Outline design motivation, objectives, and architecture
		\item Define the passive, open-loop control system transfer function
		\item Analytically demonstrate that the required output will be achieved
		\item Identify likely sources of error
		\item Numerically verify the predicted system performance
		\item Provide all information needed for further development, including shop drawings, material data, the bill of materials, and vendors for all parts
	\end{itemize}
