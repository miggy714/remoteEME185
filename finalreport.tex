		...
		\label{sec:sat:TF:results}
			...
			\begin{figure}[h]
				...
				\addplot [
						...
						x expr      = \thisrow{T_amb_C},
						y expr      = \thisrow{D_TF}          * 1e6,
						col sep     = comma,
				] {figures3/TF.csv};
				\addlegendentry{Expected output with error}
...
\begin{thebibliography}{99}
	...
	\bibitem{haas_vf2_specs}
	Haas Automation, Inc., ``VF-2: 40-Taper Standard Vertical Mill Specifications,'' \textit{Haas Automation}. [Online]. Available: https://www.haascnc.com/machines/vertical-mills/vf-series/models/small/vf-2.html. [Accessed: May 16, 2026].
...
\label{app:drawings}
	...
	The following appendix presents the detailed engineering and manufacturing drawings for the PTCD assembly and its individual components. General drawing tolerances govern the design requirements to ensure inherent reliability and precision.
