...
\subsection{Introduction to Failure Mode Effect Analysis and Methods}
	...
	The mount being made of Allvar has an anisotropic quality. It has a positive axial coefficient of thermal expansion that is \SI{2}{\micro\meter\per\meter} greater than the magnitude of the negative axial expansion \SI{30}{\micro\meter\per\meter}
