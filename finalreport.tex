...
\newcommand{\ellipselab}[1]{%
    \tikz[baseline=(char.base)]{
        \node[shape=ellipse, draw, inner sep=1pt,
            ...
            This produces seven equations for eight unknown forces $(F_M, F_A, F_S, F_T, F_H, F_V, F_B, \text{ and } F_W)$.
        ...
        \label{subsec:spec:TF:pos}
            ...
            Because $L_V$ represents the total height of the valve orifice, a multiplier is required to find the position of the square cut.
            This feature is defined as \todo{Define $K_V$}
