...
\label{chap:design}
	...
	\label{sec:design:overview}
		...
		\begin{figure}[H]
			\begin{minipage}{.49\textwidth}
				...
				\includegraphics[width=.85\textwidth]{PTCD.png}
			...
			\begin{minipage}{.49\textwidth}
				\centering
				\includegraphics[width=\textwidth]{exp_qual.png}
	...
	\label{sec:design:just}
		...
		Section~\ref{sec:DFMEA:just:weld_analysis}.
...
\label{sec:DFMEA:FMEA}
	The high performance reqsecuirements and extreme operating conditions of this device require in-depth risk assessment via Failure Mode Effect Analysis (FMEA). Possible failure modes are identified
...
\begin{figure}[h]
	...
	reflected in the RPN sheet. To ensure the welds have a sufficient FS, calculations fed by modeling results were utilized. This process is detailed in Section~\ref{sec:comp_proto}.
...
\vspace{1\baselineskip}
	\begin{figure}[H]
        \centering
        % First Subfigure (Symmetry Plane)
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=.55\textwidth]{figures3/testingch_symmetry.png}
            \caption{Symmetry plane highlights.}
            \label{fig:symmetryplane}
        \end{subfigure}
        \hfill % This pushing the two figures to the left and right margins
        % Second Subfigure (Fluid Volume)
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=.55\textwidth]{figures3/testingch_negative.png}
            \caption{Fluid domain conforming to the cavity.}
            \label{fig:fluidvolume}
        \end{subfigure}
        
        \caption{Testing channel domain mapping showing both the structural symmetry plane and the negative fluid volume.}
        \label{fig:combined_domains}
    \end{figure}
...
\label{chap:concl}
	...
	Appendix~\ref{app:iter:weak} provides an exhaustive list of identified weaknesses and unaddressed assmumptions. In summary, not all error modes could be accounted for in Chapter~\ref{chap:DFMEA},
...
\label{app:BOM}
	...
	A quote for the Wire Electrical-Discharge Machining (EDM) operation required to cut each square hole is also included from Milco Wire EDM, Inc; achievable tolerance values given in Section~\ref{sec:DFMEA:FMEA} were taken from this quote.
