...
\label{chap:design}
	...
	\label{chap:design:overview}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[height=.5\textheight, width=.5\textwidth, keepaspectratio]{CompleteAssemblyExploded.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[height=.5\textheight, width=.5\textwidth, keepaspectratio]{SubAssemblyID.png}
		...
		\todo{Uncomment the images once they are in the repo.}
		\begin{figure}[H]
			\centering
			\begin{minipage}{.45\textwidth}
				\centering
				%\includegraphics[width=.5\textwidth]{active_cold.jpg}
		...
		\label{subsec:design:overview:valve}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=\textwidth]{Valve_full.png}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[height=.49\textheight]{Valve_exploded.png}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[height=.49\textheight]{Valve_ID.png}
		...
		\label{subsec:design:overview:act}
			...
			\todo{Insert full-subsystem, exploded, and part ID images below}

			\begin{figure}
				\begin{minipage}{.5\textwidth}
					\centering
					\includegraphics[height=.5\textheight, width=\textwidth, keepaspectratio]{Act_full.png}
					\caption{Actuator subsystem}
					\label{fig:actuator_full}
				\end{minipage}
				\hfill
				\begin{minipage}{.5\textwidth}
					\centering
					\includegraphics[height=.5\textheight, width=\textwidth, keepaspectratio]{Act_exploded.png}
					\caption{Actuator subsystem exploded view}
					\label{fig:actuator_exploded}
				\end{minipage}
			\end{figure}

			\begin{figure}[H]
				\centering
				\includegraphics[width=\textwidth]{Act_ID.png}
				\caption{Actuator subsystem part identification}
				\label{fig:actuator_ID}
			\end{figure}

			This bimetallic actuator drives the valve by a difference in thermal expansion rates.
			A central Aluminum expansion rod nests inside an ALLVAR mount, suspended from above by a screw-washer assembly.
			The base of the mound it electron-beam welded to the upper exterior surface of the valve housing, centered at the valve stem, which protrudes from this surface and is welded to the base of the expansion rod.
			...
			\todo{Depict what hapens at temp changes; Justify thermal isolation}

			\todo{Mention calibration}
