...
\label{sec:project_management}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[t]{0.45\textwidth}
            ...
            \caption{Rack-and-Pinion Interface}
            \label{fig:gears}
        \end{subfigure}
        ...
        \begin{subfigure}[t]{0.45\textwidth}
            ...
            \caption{Direct mount, first iteration}
        ...
        \begin{subfigure}[t]{0.45\textwidth}
            ...
            \caption{Cylindrical Allvar Mount}
            \label{fig:cyl_mount}
        \end{subfigure}

        \caption{Design Progression}
        \label{fig:design_prog}
    \end{figure}
