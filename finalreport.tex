...
\label{chap:design}
	...
	\label{sec:design:just}
		...
		The valve stem, which passes through the bellows, measures just smaller than the bellows convolution inner diameter (\specBellowsID) to provide squirm supporta.
