...
\begin{thebibliography}{99}
	...
	\bibitem{ref_ledbetter1981}
	Ledbetter, H.~M., ``Stainless-Steel Elastic Constants at Low Temperatures,''
...
\label{app:calcs}
	...
	\label{app:calcs:belle}
		...
		\textbf{Belleville washer (part 93237A101) specifications}\cite{ref_McMaster_belle}, \cite{ref_ledbetter1981}

		\begin{itemize}
			\item Outer Diameter $OD = \SI{5}{mm}$
			\item Inner Diameter $ID = \SI{2.2}{mm}$
			\item Young's Modulus $E = \SI{193}{GPa}$
		...
		\begin{equation}
			T = K F d = (0.18) (\SI{170}{N}) (\SI{2}{mm})
		\end{equation}

		where

		\begin{align*}
			K \text{ is the nut factor (assuming Loctite is applied, which is recommended in the Manufacturing Guide - Appendix \ref{app:mfg})}
			F \text{ is the reaction load}
			d \text{ is the diameter of the M2 screw}
		\end{align*}
		
		yielding an expected torque of $\SI{1.5e-3}{N-m}$ at the 50 \textmu m compression, a very reasonable value for an M2 screw.
