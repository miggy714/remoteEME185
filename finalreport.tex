	...
	\label{chap:design:overview}
		...
		\label{subsec:design:overview:valve}
			...
			\begin{figure}[H]
				\begin{minipage}{.49\textwidth}
					\centering
					\includegraphics[height=3.5in]{V4.png}
				...
				\begin{minipage}{.49\textwidth}
					\centering
					\includegraphics[height=3.5in]{V3.png}
			...
			To hermitically seal these holes, a bellows (I718\_159\_72\_430, Figure \ref{fig:bellows}) is welded between the Valve Orifice and each Housing Center.
	...
	\label{sec:design:just}
		...
		\label{subsec:design:just:TF}
			...
			\label{subsubsec:design:just:TF:valve}
				...
				as prescribed. This specification value was informed by the orifice architecture after the design was developed; motivation for the architecture will be explained in section \ref{subsec:design:just:geo_sel}.
			...
			\label{subsubsec:design:just:TF:act}
				...
				Our target, as specified by Specification \specref{A.1.1}, is
				...
				These critical dimension ensure that 
