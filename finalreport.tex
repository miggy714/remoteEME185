		...
		\label{subsec:intro:specs:RR}
			...
			\begin{multicols}{2}
				...
				\begin{figure}[H]
					...
					\caption{Subsystem components of $\hat{G}_{RR}$. $\hat{G}_A$ (Actuator sub-transfer function) converts thermal fluctuations to axial displacement. $\hat{G}_V$ (Valve sub-transfer function) change the effective orifice diameter when it is axially displaced by the Actuator.}
					\label{fig:TF_sub}
				\end{figure}
				\newcolumn
