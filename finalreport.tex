	...
	\label{sec:DFMEA:intro}
		...
		\begin{table}[h]
			...
			\begin{tabularx}{\textwidth}{>{\centering\arraybackslash}p{1.5cm} p{3cm} p{2.5cm} p{2.5cm} p{3cm} p{3cm}}
				\toprule
				\textbf{Component \#} & \textbf{Subsystem / Component Description} & \textbf{Component Function} & \textbf{Potential Failure Mode} & \textbf{Potential Effect of Failure} & \textbf{Potential Cause of Failure} \\
				\midrule
		...
		those whose RPN exceeded the threshold value of 100 are listed in Figure~\ref{tab:RPN_priority}.
