...
\label{sec:project_management}
    ...
    We developed five distinct iterated designs, each time addressing an unavoidable source of error, resolving a manufacturing conflict, or taking advantage of an unforeseen opportunity to make the device simpler and more robust.
    ...
    \begin{enumerate}
        ...
        \item On March 11, nine days before the due date of 
        \item Gear to direct
        \item Changed mount
        \item Unfunds
    \end{enumerate}

    We learned a ton about tackling complex engineering challenges in a short time
    1-yr project in 6 months with no experience, all-or-nothing objective, changing parameters

    All told, sponsor was very agreeable and did not throw us many curveballs
    However, we underwent the following changes:

    Hexagon to pizza cutter
    Given funds, started planning prototype
    Gear to straight mount
    Changed mount geometry
    Could not afford; full pivot back to comp model
