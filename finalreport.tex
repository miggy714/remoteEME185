...
\label{chap:design}
	...
	\label{chap:design:overview}
		...
		\label{subsec:design:overview:valve}
			...
			\todo{Insert images of Valve Orifice and Housing Outlet and their assembly below}
			...
			\todo{Insert Valve Inlet image, plus one with orifice inside}
			...
			\todo{Insert Housing Center image, and one with inlet, centers, and orifice}
			...
			\todo{Insert figure of bellows, and one of it inserted into whole assembly without Outlet}
		...
		\label{subsec:design:overview:act}
			...
			\begin{figure}[H]
				\centering
				% \includegraphics[width=\textwidth]{Actuator_full.png}
			...
			\begin{figure}[H]
				\centering
				% \includegraphics[width=\textwidth]{Actuator_exploded.png}
			...
			\begin{figure}[H]
				\centering
				% \includegraphics[width=\textwidth]{Actuator_ID.png}
				\caption{Actuator subsystem part identification}
				\label{fig:actuator_ID}
			\end{figure}

			\todo{Explain bimetallic expansion}

			\todo{Justify thermal isolation}
