...
\label{sec:Specs}
    ...
    \label{sec:TF}
        ...
        In order to determine the rolldown from the Required Relationship to its relevant specifications, we must determine the system Transfer Function produced by the architecture described in section \ref{sec:Arch} to ensure that it matches equation \eqref{eq:req_TF}.
        ...
        As described in section \ref{sec:Arch}, the mount $(M)$ sits atop the housing "wall" $(W)$.
    ...
    \end{multicols}
        ...
        According to the general principle of thermal expansion\cite{ref_Hibbeler}, $\frac{d \ell}{dT} = \alpha \ell_0$ where $\alpha$ is the material coefficient of thermal expansion (CTE).
        ...
        \begin{mdframed}
            \begin{multicols}{2}
                ...
                \begin{align}
                    ...
                    \hat{G}_H &= \ell_{H_0} (1 + \alpha_{In} (T - T_{ref}))
                \end{align}
                
                \columnbreak
                
                \begin{align}
                    \hat{G}_V &= \ell_{V_0} (1 + \alpha_{In} (T - T_{ref})) \\
                    \hat{G}_B &= \ell_{B_0} (1 + \alpha_{In} (T - T_{ref})) \\
                    \hat{G}_W &= \ell_{W_0} (1 + \alpha_{In} (T - T_{ref})) \\
                    \hat{G}_R &= \ell_{R_0} (1 + \alpha_{In} (T - T_{ref}))
                \end{align}
        ...
        \begin{itemize}
            ...
            \item Allvar (ALLV): \specMountCTE\todo{Add citation for ALLV CTE}
...
\label{sec:Satisfaction}
    ...
    \todo{This section is a precursor to Section \ref{sec:Risk}. See that section for the required details; this will mostly come from Report 2 Discussion.}
...
\begin{thebibliography}{99}
    ...
    \bibitem{ref_carpenter_invar}
    Carpenter Technology Corporation, \textit{Invar 36 Datasheet}, CRS Holdings LLC, 2025. [Online]. Available: \url{https://www.carpentertechnology.com/hubfs/7407324/Material%20Saftey%20Data%20Sheets/Invar%2036.pdf}
    [Accessed: Apr. 17, 2026].
