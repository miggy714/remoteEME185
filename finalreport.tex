...
\label{chap:specs}
    ...
    \label{sec:specs:TF}
        ...
        \todo{Update TF; pdf has unrendered changes (4-18)}
        ...
        \label{subsec:spec:TF:pos}
            ...
            Each square opening is defined such that the valve orifice will be exactly centered at $T_ref$.

            \begin{figure}[H]
                \centering
                \begin{minipage}{.45\textwidth}
                    \centering
                    \includegraphics[height=.5\textheight]{K_V.png}
                    \subcaption{Leading orifice geometry}
                    \label{fig:K_V}
                \end{minipage}
                \hfill
                \begin{minipage}{.45\textwidth}
                    \centering
                    \includegraphics[height=.5\textheight]{K_H.png}
                    \subcaption{Trailing orifice goemetry}
                    \label{fig:K_H}
                \end{minipage}
                \caption{Spring deflection}
                \label{fig:springs}
