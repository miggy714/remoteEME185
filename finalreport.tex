...
\newcommand{\Aone}{\SI{-1.524e-3}{\frac{mm}{\degC}} \pm 5\%}
\newcommand{\Azero}{\SI{0.254}{mm} \pm 5\%}
...
\label{chap:intro}
	...
	To passively control the flow of a gas, this design requires two coupled subsystems:
	...
	Our three givens --- the Required Relationship, Mechanical Envelope, and operational conditions --- drive the design specifications, which will in turn motivate the optimal design architecture.
		...
		\label{subsec:intro:specs:RR}
			...
			\todo{Delete this: \ref{sec:sat:TF}}
			...
			\begin{multicols}{2}
				...
				\begin{equation}
					D_{eff} = \frac{dD}{dL} \frac{dL}{dT} (T_{amb} - T_{ref}) + D_{ref} \\
					= A_1 \Delta T + A_0
				\end{equation}
				...
				\begin{align*}
					\frac{dL}{dT} &\text{ is determined by the actuator, and}
			...
			\subsubsection{Actuator specifications}
			...
			\begin{itemize}
				...
				\item \textbf{Linearity}
					\begin{itemize}
						\item The actuator must expand consistently across the whole temperature range.
		...
		\label{subsec:intro:specs:ME}
			...
			\todo{Move the below to design justification, section \ref{chap:design}}
			...
			The actuator must use dissimilar metals to increase its actuation distance.
...
\label{chap:sat}
	...
	\label{sec:sat:TF}
		...
		\todo{Delete this: \ref{subsec:intro:specs:RR}}

		Recall from Section \ref{subsec:intro:specs:RR} that the Required Relationship, the core objective of the \device, is best described as a passive system transfer function.
