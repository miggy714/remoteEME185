...
\begin{itemize}
    ...
    \item Defines the complete system transfer function
    \item Analytically demonstrates that the control system produces the required output
    \item Identifies likely sources of error
    \item Numerically verifies the predicted system performance
\end{itemize}

It includes a full drawing package, bill of materials, product data sheets, and vendor contact information.
...
\todo{Update to final task list (from spreadsheet) and Gantt chart. As listed in template, tell the story of this quarter. We should all participate in this.}
