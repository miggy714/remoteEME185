...
\label{chap:intro}
	...
	\label{sec:intro:motive}
		...
		\label{subsec:intro:motive:background}
			...
			These experiments are hyper-sensitive to environmental temperature fluctuations and must be tightly controlled.
			...
			However, the lab technicians often cannot actively monitor or control the flow due to energy, personnel, or space constraints.
			...
			\label{subsec:intro:motive:objectives}
				...
				\begin{itemize}
					\item Restrict the provided flow of gas, at a pressure of up to 680 atmospheres, with an orifice smaller than the tip of a ballpoint pen.
...
\label{chap:design}
	...
	\label{chap:design:overview}
		...
		The outer material, ALLVAR, shrinks when heated, which the inner material, Aluminum, expands.
	...
	\label{sec:design:just}
		...
		\todo{This is where we show the progression from design specifications to architecture \textit{and dimensions}. Include all quantitative justifications in this section. If needed, split this into two sections -- qualitative and quantitative -- but I'd like to keep individual design items together.}
