...
\newcommand{\SpecVB}{The valve subsystem shall not exceed a 10 cm $\times$ 71 cm $\times$ 10 cm mechanical envelope}
...
\newcommand{\SpecAB}{The actuator subsystem shall not exceed a 10 cm $\times$ 44 cm $\times$ 10 cm mechanical envelope}
\newcommand{\SpecACA}{The actuator shall remain thermally isolated from the gas flow}
...
The required mathematical relationship between the ambient temperature and a characteristic orifice geometry, as provided by Sandia National Labs (SNL, aka the "sponsor" or the "client"),
...
\label{chap:intro}
	...
	\todo{Personal preference (Sam): Don't use the phrase "PTCD" until section \ref{chap:design}. Helps with the big-reveal effect.}
	...
	\label{sec:intro:motive}
		...
		\label{subsec:intro:motive:objectives}
			...
			\todo{This is the second half of Background; now that the "problem" has been established, the flow of thought progresses to "it would be nice if we had a device that could do X for us." Until Section \ref{chap:design}, the \device\ will be referred to as the "valve".}
