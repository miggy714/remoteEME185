...
\label{chap:sat}
    ...
    \label{subsec:sat:TF:orif}
		...
		\label{sec:sat:TF:results}
			...
			It also serves to validate the results produced by the computational prototype that will be introduced in section \ref{chap:comp}.
...
\label{app:calcs}
	...
	\label{app:calcs:errorProp}
		...
		See Appendix \ref{app:mfg} for more detials.
	...
	\label{app:calcs:TF}
		...
		\label{app:calcs:TF:results}
			...
			Each stochastic machining error follows a normal distribution, where its tolerable range holds approximately six standard deviations $(6 \sigma)$ for a typical Computer-Numeric Control (CNC) machine\ref{ref_AIAG2005}.
...
\renewcommand{\thesection}{\arabic{section}}
	...
	\color{red}
		\begin{itemize}
			...
			\item Calibrate at room temp, approximately Tref
		\end{itemize}
	\color{black}
