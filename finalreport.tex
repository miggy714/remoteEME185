...
\newcommand{\A1}{\specDeffConstOne mm \specTolerancePercent}
\newcommand{\A0}{\specDeffConstTwo mm \specTolerancePercent}
...
\label{sec:Specs}
    ...
    A passive control system, such as the \device, can be represented by a simple open-loop diagram as in Figure \ref{fig:controls_gen}.
    ...
    To satisfy the system requirements, $\hat{G}_sys$ must equal the Required Relationship from equation \eqref{eq:required_relationship}:
        ...
        \begin{equation}
            \hat{G}_sys = A_1 (T-T_{ref}) + A_0 = (\A1)(T-T_{ref}) + (\A0)
            \label{eq:req_TF}
        \end{equation}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.5\textwidth]{controls_gen.png}
        \caption{General Passive Open-Loop Controls Diagram}
        \label{fig:controls_gen}
    \end{figure}

    \begin{figure}[H]
        \centering
        \includegraphics[width=.5\textwidth]{TF.png}
