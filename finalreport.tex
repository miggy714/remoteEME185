...
\begin{figure}[h]
	...
	The threshold RPN was chosen to be 100. Since human operators do not come into direct contact or operate the PTCD directly, the main failure risks 
	...
	Of the critical failure modes, two of them are on welds.
