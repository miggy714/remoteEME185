...
\label{chap:design}
	...
	\end{equation}
		...
		\label{subsec:design:just:gen_dim}
			...
			The coating is applied using Physical Vapor Deposition (PVD), a process that deposits a thin film (about 2-4 microns thick) of material onto the surface of the substrate.
...
\renewcommand{\thesection}{\arabic{section}}
	...
	\color{red}
		\begin{itemize}
			...
			\item Apply coat to orifice (TiCN)
