...
\label{chap:sat}
	...
	\label{sec:sat:error}
		...
		\label{subsec:sat:error:CTE}
			...
			$\delta L {(T_{\text{ref}} \to T_{max})} = L_0 \alpha \Delta T = (\SI{84.335}{\milli\meter})(\SI{22.7e-6}{\per\celsius})(\SI{70}{\celsius}) = \SI{0.1339}{\milli\meter}$  
			...
			\begin{align*}
				...
				&= \SI{84.335}{\milli\meter} \int_{\SI{10}{\celsius}}^{\SI{80}{\celsius}} (0.0058T + 22.6) \times 10^{-6} \, dT \\
				&= (\SI{84.335}{\milli\meter})\left[(0.0058(\SI{80}{\celsius})^2 + 22.6(\SI{80}{\celsius})) - (0.0058(\SI{10}{\celsius})^2 + 22.6(\SI{10}{\celsius}))\right] \times 10^{-6} \\
				&= \SI{0.1363}{\milli\meter}
			\end{align*}
			...
			$\text{Error} = \Delta L_{actual} - \Delta L_{expected} = \SI{0.1363}{\milli\meter} - \SI{0.1339}{\milli\meter} = \SI{2.4}{\micro\meter}$

			The \SI{2.4}{\micro\meter} fall much below the error range of our design requirements so even added with the other errors that will occur in our system we will fall within the design requirements.
			...
			$$\sqrt{ \left( L_0 u_{\alpha} \right) ^2 + \left( \alpha u_{L_0} \right) ^2} = \sqrt{ \left( \SI{84.335}{\milli\meter} \cdot \SI{2.4}{\micro\meter} \right) ^2 + \left( \SI{23e-6}{\per\celsius} \cdot \SI{5}{\micro\meter} \right) ^2} = \SI{0.2}{\micro\meter} \leq \SI{0.3}{\micro\meter}$$
