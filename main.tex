...
Explicitly, the relationship between the orifice diameter and the ambient temperature can be summarized as $D_{\text{effective}} = A_1 (T_{\text{ambient}} - T_{\text{reference}}) + A_0$ which will be referred to as the "required relationship" throughout this report.
...
\begin{table}[H]
    \centering
    \caption{Requirements and specifications summary}
...
\todo{State the single concept being carried forward. Briefly describe the alternative and how
systematic screening and weighted scoring matrices (see Appendix~\ref{app:scoring}) was used''}
...
\begin{table}[H]    
    \centering
    \caption{Requirements rolldown from system to subsystem level.}
    \label{tab:rolldown}
