...
\label{sec:system_architecture}
    ...
    \label{sec:sys_arch_overview}
        ...
        The system transfer function inputs $T_{ambient}$, outputs $D_{effective}$, and can be represented by the general equation
        ...
        \begin{figure}[H]
            ...
            \caption{new controls diagram. Program in Latex as above.}
