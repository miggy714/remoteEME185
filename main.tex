...
expansion and the resisting forces have negligible effect on rod length.
    ...
    \section{Mount Subsystem}
        ...
        \subsection{Trapezoidal Mount Plate Current Implementation}
            The two trapezoidal mount plates are machined from Invar 36 nickel-iron alloy. The plates rise vertically from the fixture and taper inward toward the top, forming the A-frame geometry visible in figure xyz. The actuator rod fits in the cavity between the two plates with the upper end welded to the interior
