...
\newcommand{\valveMEX}{\textbf{valveMEXPlaceholder}}
\newcommand{\valveMEY}{\textbf{valveMEYPlaceholder}}
\newcommand{\valveMEZ}{\textbf{valveMEZPlaceholder}}
...
\label{sec:system_architecture}
    ...
    \label{sec:sys_arch_overview}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4in, width=6in, keepaspectratio]{Main_isometric.png}
            ...
            \begin{figure}[H]
            \centering
            \includegraphics[height=4in, width=6in, keepaspectratio]{Main_exploded.png}
    ...
    \label{sec:valve_sub_description}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4in, width=6in, keepaspectratio]{Valve_isometric.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4in, width=6in, keepaspectratio]{Valve_exploded.png}
...
\label{sec:discussion}
    ...
    \section{Valve}
        ...
        \label{subsec:valve_spec_4}
            ...
            \todo{Insert a simple heat transfer calculation at steady-state given a 20 $\degC$ temperature difference. Find the temperature at the valve stem / actuator interface; it will be hotter than $T_{ambient}$}
        ...
        \label{subsec:valve_spec_6}
            ...
            \todo{Briefly show that dimensions along principle axes lie within \valveMEX\ lateral, \valveMEY\ vertical, or \valveMEZ\ longitudinal dimensions}
