...
\label{sec:discussion}
    ...
    \section{Actuator}
        ...
        An amplifying interface between the valve stem and actuator was designed to increase expansion to the necessary stroke length
        via a gear train. This allowed the system to meet actuation distance needs of the valve while keeping within the mechanical 
        envelope. Discussion with subject matter experts and further uncertainty calculations showed that backlash and machining 
        inaccuracies would be compounded by the gear
        ...
        exotic materials with higher linear coefficients of expansion to minimize foray. Research on actuator materials has solidified
