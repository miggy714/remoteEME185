...
\todo{Write 300--500 word abstract. Cover the following points:}

% PARAGRAPH 1: Problem and motivation
% - What is the problem? (Sandia needs a passive flow control device)
% - Why does it matter? (Current solutions require active control/electronics)
% - What are the operating conditions? (-60°C to +80°C, 100-10000 psid, hydrogen)
\todo{Paragraph 1: Problem statement and motivation. Mention that \organization{}
needs a thermomechanical device (the \tcd{}) that adjusts flow path resistance
based solely on ambient temperature, without electronics or active control.
Operating range: \SI{-60}{\celsius} to \SI{+80}{\celsius}, pressure differentials
of \SI{100}{} to \SI{10000}{\psid}, within a \SI{10}{\centi\meter} $\times$
\SI{10}{\centi\meter} $\times$ \SI{10}{\centi\meter} envelope.}

% PARAGRAPH 2: Solution and progress
% - Which concept did we select? (state it clearly)
% - What have we accomplished this quarter?
% - What are the next steps?
\todo{Paragraph 2: Describe the selected system architecture at a high level.
Summarize key progress: concept generation, screening/scoring matrices,
selection of final design, preliminary calculations, and engineering drawings.
Mention what will happen in Spring quarter (fabrication, testing).}
...
\end{document}
% RAMON MAGSAYSAY ADDITIVE CHANGE