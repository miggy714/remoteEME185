    ...
    \section{Mount Subsystem}
     ...
     \subsection{Overview}
        ...
        \label{tab:trapmountthermalexpansion}
            The net displacement delivered to the valve is the difference between the actuator's thermal expansion and the mount's thermal expansion over the same vertical span. Accounting for the operating temperature range and using the coefficient of thermal exapnsion for Invar 36,
            let $\Delta L$ be the amount the mount expands:
            
            $$\Delta L = H \Delta T \alpha = (122.48)(85)(1.20\times10^\text{-6}) = 12.5 \mu\text{m}$$
