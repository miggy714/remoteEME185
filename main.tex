...
\newcommand{\pressureSF}{\textbf{pressureSFPlaceholder}}
...
\newcommand{\dLdTTol}{\textbf{dLdTTolPlaceholder}}
...
\label{sec:system_architecture}
    ...
    \label{sec:valve_sub_description}
        ...
        \subsection{Valve Selection Criteria}
            ...
            \multirow[c]{2}{0.45\textwidth}{%
                ...
                of the actuator $\frac{dX}{dT}$
                by more than \dXdTTol%
            }
            &
            \rule{0pt}{1.5em}Prevent a temperature gradient of less than \dTTol\ between the internal gas and the point of contact with the actuator
            \\ \cline{2-2}
            &
            ...
            \todo{Add spec for mechanical envelope}
    ...
    \label{sec:act_sub_description}
        ...
        \todo{Add ref to an EME 109 textbook, chapter on Kline-McClintock error propagation}
            ...
            \multirow[c]{2}{0.45\textwidth}{%
                Must govern $\frac{dL}{dT} = \sqrt{\frac{2}{\pi}} A_1$ to within \dLdTTol%
            }
            &
            Limit the error of $\alpha$ and $L_0$ such that 
                $\sqrt{ \left( L_0 u_{\alpha} \right) ^2 + \left( \alpha u_{L_0} \right) ^2} \leq \dLdTTol$
            \\ \cline{2-2}
            &
...
The joint is viable with a thickness margin of $3.01\ \text{mm}$ and a stress safety factor of $1.48$.
    ...
    \begin{table}[H]
            \centering
            \caption{Mount Specifications}
            \label{tab:mount specification}
            \begin{tabularx}{\textwidth}{l X l}
                \toprule
                \textbf{Requirements} & \textbf{Design Specification} & \textbf{Implemented Specification} \\
                \midrule
