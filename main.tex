...
\label{sec:system_architecture}
    ...
    \label{sec:sys_arch_overview}
        ...
        \begin{figure}[H]
            ...
            \begin{figure}[H]
            \centering
            \includegraphics[height=4in]{Main_exploded.png}
        ...
        Thus, the entire system can be summarized by the open-loop control diagram represented by Figure \ref{fig:controls_diagram} .
    ...
    \section{Valve images}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4in]{Valve_isometric.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4in]{Valve_exploded.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4in]{Valve_cutaway_isometric.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4in]{Valve_cutaway_normal.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4in]{Valve_interior.png}
    ...
    \section{Actuator images}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4in]{Actuator_isometric.png}
            \caption{Valve orifice front view}
    ...
    \section{Mount images}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4in]{Mount_isometric.png}
            \caption{Valve subsystem cutaway view}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4in]{Mount_exploded.png}
            \caption{Valve subsystem internal mechanism}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4in]{Mount_cutaway_oblique.png}
            \caption{Valve orifice front view}
