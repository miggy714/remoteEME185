...
\label{sec:system_architecture}
    ...
    % Paragraph 2
    The critical property of this geometry is that the area of the diamond orifice depends linearly on the vertical offset between the two plates. Since the effective diamater is derived from the orifice area, the resulting relationship is linear between the plate displacement and the effective diameter.
