...
\label{sec:discussion}
    ...
    \section{Actuator}
        ...
        be compounded by the gear train. This would push the entire system out of error tolerance. 
        This influenced an increase in the weighted importance of tolerance and sparked discussion with
        our sponder about flexability of the mechanical envelope as eliminating the gear train and
        extending actuator length would significantly reduce error. 
