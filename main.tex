...
%Mount tolerances
\newcommand{\mountdLTol}{$0.01 \mu m$}
...
{%
    \begin{tabular}{|m{0.45\textwidth}|m{0.5\textwidth}|}
        ...
        Must fit withing its portion of the Mechanical Envelope
        &
...
\label{sec:system_architecture}
    ...
    \label{sec:act_sub_description}
        ...
        Thus, assuming $\frac{dD}{dX} = -\sqrt{\frac{2}{\pi}}$ and $\frac{dX}{dX} = 1$ within the valve subsystem
...
the mount material should minimize $\alpha_{mount}$ relative to $\alpha_{act}$.
        ...
        \end{figure}
            ...
            % Paragraph 2
            The two trapezoidal mount plates are fabricated from Invar 36 in order minimize the thermal expansion and therefore error caused by the mount. They are vertically oriented to form an A-frame structure and mounted through the housing onto the fixture as seen in Fig. \ref{fig:mount_cutaway_oblique}. The actuator rod is housed inside the cavity between the A-frame structure. The upper end is anchored onto the interior top face of the mount.
        ...
        \end{figure}
            ...
            % Paragraph 4
            The eight socket head cap screws secure the mount plates to the fixture. Each fastener passes through the mount from the top through the housing and threads into the fixture at the base. On top of the mount, each screw is seated against a stainless steel washer to distribute the clamping load. Between the underside of the mount and the top face of the housing, three washers are stacked in the following order (top to bottom):
            \begin{enumerate}
    ...
    \section{Valve Subsystem}
        ...
        \label{subsec:valve_spec_2}
                ...
                \todo{This demonstrates that the valve stem won't break given the maximum specifiec load.
                    Add proof that it will not deflect or expand by more than \dXdLTol\ due to force compression.
                ...
                This is slightly higher than expected but it still much lower than the requirements. In addition, this error is opposite of the thermal expansion error caused by the mount and the mount is much larger than the 
                valve stem, so then in all practicality the error from the valve stem will completely erased by the error caused by the mount.
...
expansion and the resisting forces have negligible effect on rod length.
    ...
    \section{Mount Subsystem}
        ...
        \label{subsec:mount_spec_1}
            ...
            The dimensions between the base of the mount and the upper interior, where the actuator will be mounted, is specified as 0.005 $\mu$m in the engineering drawings.
        ...
        \label{subsec:mount_spec_2}
            ...
            After calculation of the expected post-assembly value of $X(T_{ref})$, the we can increase the height of the mount by one of three values:
        ...
        \label{subsec:mount_spec_3}
            ...
            The net displacement delivered to the valve is the difference between the actuator's thermal expansion and the mount's thermal expansion over the same vertical span. If $L_act$ is the actuator rod length and H is the mount height from the actuator
            ...
            The difference in the coefficient of thermal expansion is the effective CTE driving the valve. To deliver a net stroke of 267 $\mu$m across the 140 $\degC$ operating range, the required actuator length is:
            ...
            This is only half the required value. Therefore, it is necessary to implement and consider the thermal expansion of the mount in correspondence with the actuator. 
...
=======
            The two trapezoidal mount plates are machined from Invar 36 stock. The plates rise vertically from the fixture and taper inward toward the top, forming the A-frame geometry visible in figure xyz. The actuator rod fits in the cavity between the two plates with the upper end welded to the interior
>>>>>>> 1ae5b75d97ed0a5460c27f8b845885e9e9434c57
...
=======
            ...
            (F/2 = 84.48 N), and approximating the minimum cross sectional moment of inertaion from the plate geometry:
...
>>>>>>> 1ae5b75d97ed0a5460c27f8b845885e9e9434c57
    ...
    \label{subsec:sys_comp}
        ...
        The specified tolerances for each control derivative in the transfer function is in Table \ref{tab:tol_final}.
