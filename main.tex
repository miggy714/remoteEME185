...
expansion and the resisting forces have negligible effect on rod length.
    ...
    \section{Mount Subsystem}
     ...
     \subsection{Overview}
        ...
        \subsection{Trapezoidal Mount Thermal Expansion}
        ...
        A standard 18-8 M4 stainless steel oversized washer sits under each screw head to distribute the clamping load across the mount plate surface. 
