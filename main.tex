...
\label{sec:discussion}
    ...
    \section{Valve Subsystem}
        ...
        \label{subsec:valve_spec_2}
                ...
                \begin{equation}
                    \delta_{compression} = \frac{F *L_{stem}}{\pi d_{stem}^2/4 E} = 5.09075 \text{ microns}
                ...
                This is slightly higher than expected but it still much lower than the requirements. In addition, this error is opposite of the thermal expansion error caused by the mount and by actuator over-expansion (discussed in chapter \ref{sec:act_sub_description}) and the mount is much larger than the 
                valve stem. Note that within the valve stem the total deflection will be that of thermal expansion minus that of compression: $5.0975-2.45 = -2.6475 \text{ microns}$
...
expansion and the resisting forces have negligible effect on rod length.
    ...
    \section{Mount Subsystem}
     ...
     \subsection{Overview}
        ...
        \subsubsection{Trapezoidal Mount Plate Current Implementation}
        ...
        \subsubsection{Trapezoidal Mount Thermal Expansion}
