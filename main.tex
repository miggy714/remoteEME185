% Gentlemen, congradulations on finishing this report!
% Several portions of this will likely be copy-pasted into the Final Design Report,
% and given that we had to rush certain components,
% it would be prudent to implement post-hoc edits to this version of the report for our reference.
% I pushed our final submission today and tagged it as such,
% so we can safely make revisions and push them.
...
\label{sec:discussion}
    ...
    \section{Valve Subsystem}
        ...
        \label{subsec:valve_spec_2}
                ...
                Note that within the valve stem the total deflection will be that of thermal expansion minus that of compression: $5.0975-2.45 = -2.6475 \text{ microns}$. This is jut lower than the specificaton of 2.75 $\mu$m.
