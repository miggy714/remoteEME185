...
\label{sec:discussion}
    ...
    \section{Design Requirement Updates(Roll-down)}
    ...
    \section{Valve}
        \begin{table}[H]
            ...
            \end{tabularx}
        \end{table}
        \subsection{Bellows Description and Calculations}
    ...
    \section{Actuator}
        ...
        \subsection{Thermal Expansion and Actuator Displacement}
            ...
            \subsection{Force Analysis Under Pressure Loading}
