...
\label{sec:system_architecture}
    ...
    \label{sec:valve_sub_description}
        ...
        \end{figure}
            ...
            % Paragraph 4
            It's important to note that the wetted valve components are entirely metallic. The 1018 Cold-rolled steel is fully compatible with hydrogen and noble gases. The valve housing itself is a thick-walled cylinder designed to contain the full 68.95 MPa of operating pressure. The bellows provide a hermetic seal that
...
where $\theta_{x_i} = \frac{\partial x_0}{\partial x_i}\bigg|_{x_i = \bar{x}_i}$ \cite{ref_Figliola}.
