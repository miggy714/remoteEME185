...
\label{sec:system_architecture}
    ...
    Bottom plate, two symmetrical trapezoidal mounts that serve to weld the top of actuator securing actuator. Both trapezoidal mounts are secured by 8 fasteners. not part of the purview of the mount, but the valve stem and actuator are laser welded and secured.
    trapezoidal holes in design are what allows the weld to occur.  
