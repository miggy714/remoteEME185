...
%--- BEGIN CONTENT ---
    ...
    \todo{Mention that this BOM does not include mfg or testing costs, and that SNL will have an indefinite budget to implement a more precise, exotic design}

\todo{Insert BOM from Google Sheets. Use larger page size if needed.}
...
\todo{Add notes about any pending updates: awaiting price for bellows, manufacturing costs.
    These will add to the total cost significantly.}
