...
\label{sec:system_architecture}
    ...
    \label{sec:sys_arch_overview}
        ...
        \begin{equation}
            D_{eff}=\frac{dD_{eff}}{dX} \left[\frac{dX}{dT}+X\left(T_{ref} \right) \right]
        ...
        \begin{equation}
            \frac{dD_{eff}}{dX} \cdot \frac{dX}{dT} = A_1
            \label{eq:actuator_control}
        \end{equation}

        The control derivative $\frac{dX}{dT}$ will be governed by the actuator subsystem. 
