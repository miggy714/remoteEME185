...
\label{sec:system_architecture}
   ...
   \begin{align*}
\Delta L &= L_0 \int_{10}^{80} \alpha(T) \, dT \\
...
\label{sec:discussion}
    ...
    \section{Mount}
        ...
        \subsection{Trapezoidal Mount Plates}
            ...
            % Pargraph 1: Design Requirement Updates
            ...
            % Paragraph 2: Current Implementation
            The two trapezoidal mount plates are machined from 1018 cold-rolled steel stock. The plates rise vertically from the ficture and taper inward toward the top, forming the A-fram geometry visible in figure xyz. 
