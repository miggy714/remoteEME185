...
\end{align*}
\todo{Include : withstand pressure differentials up to \SI{68.94757}{MPa} during choked flow}
...
%--- BEGIN CONTENT ---
% --- 2.1: Selection Criteria and Design Justification ---
% Valve, Interface, and Actuator 

Based on the requirements of the project, our 
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l X l}
        \toprule
        \textbf{Requirements} & \textbf{Specification} & \textbf{Subsystem Specification} \\
        \midrule
        Mech.\ envelope &
        $\leq$ \specVol\ cm$^3$ &
        ...
        Pressure &
        $\Delta P \leq 68.95$~MPa &
        TODO: Insert FOS or necessary param.
        \\\addlinespace
        Eff.\ diameter &
        $D_{\text{eff}}$ = 0.170--0.384~mm & 
