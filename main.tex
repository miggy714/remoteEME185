    ...
    \section{Mount Subsystem}
     ...
     \subsection{Overview}
        ...
        \subsection{Trapezoidal Mount Plate Current Implementation}
            The two trapezoidal mount plates are machined from Invar 36 stock. The plates rise vertically from the fixture and taper inward toward the top, forming the A-frame geometry visible in Figure \ref{fig:mount_cutaway_oblique}. The actuator rod fits in the cavity between the two plates with the upper end welded to the interior
