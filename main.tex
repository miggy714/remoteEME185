...
\label{sec:discussion}
    ...
    \subsection{Specification 1: Delivers necessary stroke length}
        ...
        \subsection{Specification 2: Thermal expansion tolerance}
        \label{subsec:act_spec_2}

            \todo{Insert propagated error proof as specified (Sam?)}
