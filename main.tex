...
\label{sec:system_architecture}
    ...
    prevents any gas leakage to the enviornemnt. Thus, the housing wall thickness, weld joint quality, and bellows all together provide a robust margin of safety against the pressure requirment. See Section 3.1 for more details. 
        ...
        \todo{For each subsystem below, list the specifications in detail.
            Describe the function of the subsystem and its components with as many helpful renders as needed.
            Use screenshots as placeholders for the renders.}
    ...
    % Paragraph 1
    The mount subsystem is a rigid structural frame fabricated from 1018 Cold-rolled steel. The function is to fix the actuator and valve housing such that the thermal expansion of the actuator rod is transmitted entirely into valve stem. Having the rigid fram enables the transmission to be direct eliminating the possibility of relative motion lost
    between components. 

    Bottom plate, two symmetrical 
...
>>>>>>> cf03c3d020426de2f8efeb6217f85307bf77611b
%--- END CONTENT ---
