...
\label{sec:system_architecture}
    ...
    \label{sec:initial_system_requirements}
        ...
        \todo{Include definition of effective diameter with reference}
    ...
    \label{sec:sys_arch_overview}
        ...
        \todo{Include noncolored copy of drawing with subsystem callouts as in drawings. See how they did this in sample.}
        ...
        \todo{Replace \ref{fig:mainExploded} with an assembly with all the parts exploded}
    ...
    \label{sec:mount_sub_description}
        ...
        \subsection{Mount Architecture}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[height=4in, width=6in, keepaspectratio]{Mount_isometric.png}
                \caption{Valve subsystem cutaway view}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[height=4in, width=6in, keepaspectratio]{Mount_exploded.png}
                \caption{Valve subsystem internal mechanism}
...
\label{sec:discussion}
    ...
    \subsection{Specification 1: Delivers necessary stroke length}
        ...
        and other unmodeled losses in the actuator-valve system, as well as the spring constant of
        the bellows.
