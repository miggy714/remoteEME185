...
This Preliminary Machine Architecture Report outlines our design criteria, demonstrates requirement satisfaction, and outlines details for 

outlines the design requirements, specification rolldown, and how each subsystem meets those requirements.
...
\label{sec:system_architecture}
    ...
    \label{sec:valve_sub_description}
        ...
        \end{figure}
            ...
            prevents any gas leakage to the environment. Thus, the housing wall thickness, weld joint quality, and bellows all together provide a robust margin of safety against the pressure requirment. See Section 3.1 for more details. 
...
\label{sec:discussion}
    ...
    \section{Valve Subsystem}
        ...
        \label{subsec:valve_spec_3}
            ...
            The three sections of the valve housing are joined using welded connections which are designed 
