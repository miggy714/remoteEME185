...
% ============================================================================
% SECTION 4: FINAL BILL OF MATERIALS
% ============================================================================
...
\chapter{Final Bill of Materials}
\label{sec:bom}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot[thick, mark=none, color={rgb,255:red,0;green,200;blue,00}] table [x=T, y=D, col sep=comma] {figures2/D.csv};
                    \addlegendentry{$\overline{D}(T)$}

                    \addplot[thick, mark=none, red] table [x=T, y=Hi, col sep=comma] {figures2/D.csv};
                    \addlegendentry{Upper limit}

                    \addplot[thick, mark=none, blue] table [x=T, y=Lo, col sep=comma] {figures2/D.csv};
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot[thick, mark=none, blue] table [x=T, y=u_D, col sep=comma] {figures2/u_D.csv};
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot[thick, mark=none, color={rgb,255:red,0;green,200;blue,00}] table [x=T, y=X, col sep=comma] {figures2/X.csv};
                    \addlegendentry{$\overline{X}(T)$}

                    \addplot[thick, mark=none, red] table [x=T, y=Hi, col sep=comma] {figures2/X.csv};
                    \addlegendentry{Upper limit}

                    \addplot[thick, mark=none, blue] table [x=T, y=Lo, col sep=comma] {figures2/X.csv};
                    \addlegendentry{Lower limit}
                \end{axis}
            \end{tikzpicture}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot[thick, mark=none, blue] table [x=T, y=u_x, col sep=comma] {figures2/u_X.csv};
