...
\begin{abstract}
	...
	Full design justification, verification, and tools for further iteration are provided in the Final Design Report by the same authors\cite{ref_finalDesignReport}.
...
\label{chap:DFMEA}
	...
	\section{Design Failure Mode Effect Analysis}
	\label{sec:DFMEA:intro}

		The high performance requirements and extreme operating conditions of the \device\ require in-depth risk assessment via Design Failure Mode Effect Analysis (DFMEA). Possible failure modes are identified
...
\subsection{Actuator-Housing Weldment}
	...
	to seal, and worries regarding hydrogen compatability can also be relaxed.
...
\label{chap:concl}
	...
	affording a more informed trade-off analyses between satisfaction of the Required Relationship and smaller priorities such as size, cost, and longevity.
...
\begin{thebibliography}{99}
	...
	Noble Aggie Labs, University of California, Davis, CA, Jun.\ 6, 2026 [Unpublished].
