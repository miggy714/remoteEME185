...
\label{chap:Fintro}
	...
	\label{sec:intro:motive}
		...
		\label{subsec:intro:motive:objectives}
			...
			Thus, as depicted in Figure~\ref{fig:conceptual}, the \device\ would provide thermomechanical (temperature-driven) flow control to delicately manipulate experimental conditions.
			...
			Figure~\ref{fig:app_SNL} illustrates the \device's niche role. Sandia National Labs (SNL) develops ``science and technology to resolve the nation's most challenging security issues''\cite{ref_SNL}.
